        ...
        <section className="section--main" id="Main" >
            ...
            <div className="content--text-main">
                <div className="text--main">
                    <h1 className="title--main">Olá, eu sou <span>{'{'}Alves{'}'}</span>.<br/>Um desenvolvedor<br/>Front-end</h1>
                </div>
                <div className="buttons--main">
                <div className="buttons--main-linkedin">
                    <a href="https://www.linkedin.com/in/alves-dev-06bb08188/" target="_blank">Linkedin</a>
                    <img src={SvgLinkedin} alt="" />
                </div>
                <div className="buttons--main-git">
                    <a href="https://github.com/alvesxdev" target="_blank">GitHub</a>
                    <img src={SvgGit} alt="" />
                </div>
                </div>
            </div>
